...
ABN = os.environ.get("ABN", "60 578 933 517")
SALES_TAX = os.environ.get("SALES_TAX", "60578933517")
PADDLE_TOKEN = os.environ.get("PADDLE_TOKEN", "live_0fcc154c8d0a7d55e605623a72f")
# Location helpers
def get_location():
